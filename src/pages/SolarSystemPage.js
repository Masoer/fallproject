    ...
    return (
      <>
        <div className="container">
          ...
          <div className="sol">
            <img src={SolSystem} alt="" className="solar system" />
            <div className="info">
              <p>
                The Sol system consists of the Sun and everything that orbits,
                or travels around, the Sun. This includes the eight planets and
                their moons, dwarf planets, and countless asteroids, comets, and
                other small, icy objects. However, even with all these things,
